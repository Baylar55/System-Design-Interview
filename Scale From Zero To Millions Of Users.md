...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-1.png" alt="Single Server Setup" />
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-2.png" alt="Single Server Setup" />
</div>

1. Users access websites through domain names, such as `api.mysite.com`. Usually, the Domain Name System (DNS) is a paid service provided by third parties and not hosted by our servers.

2. An Internet Protocol (IP) address is returned to the browser or mobile app. In this example, the IP address `15.125.23.214` is returned.
...
**Web application:** It uses a combination of server-side languages (Java, Python, etc.) to handle business logic, storage, and related processing, and client-side languages (HTML and JavaScript) for presentation.

**Mobile application:** HTTP is the communication protocol between the mobile app and the web server. JSON is a commonly used API response format to transfer data because of its simplicity. An example API response in JSON format is shown below:
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-3.png" alt="Single Server Setup" />
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-4.png" alt="Single Server Setup" />
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-5.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-6.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-7.png"/>
</div>

After receiving a request, a web server first checks if the cache contains the requested data. If it does, the server returns the cached response directly to the client. If not, it queries the database, stores the result in the cache, and then returns the response to the client.

This caching strategy is called a **read-through cache**.

Other caching strategies exist depending on the data type, size, and access patterns. A previous study explains how different caching strategies work [6].

Interacting with cache servers is straightforward because most cache systems provide APIs for common programming languages. The following code snippet shows typical Memcached APIs:
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-8.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-9.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-11.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-12.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-14.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-15.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-16.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-17.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-18.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-19.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-20.png"/>
</div>
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-21.png"/>
</div>

Figure 22 shows the user table in sharded databases.

<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-22.png"/>
</div>
...
**J*oin and de-normalization**: Once a database has been sharded across multiple servers, it is hard to perform join operations across database shards. A common workaround is to de-normalize the database so that queries can be performed in a single table.
...
<div align="center">
  <img src="images/scale-from-zero-to-millions-of-users/figure-23.png"/>
</div>

## Millions of Users and Beyond

Scaling a system is an iterative process. Iterating on what we have learned in this chapter can take us far. However, additional fine-tuning and new strategies are required to scale beyond millions of users.

For example, you may need to further optimize your system and decouple it into smaller services. The techniques covered in this chapter provide a solid foundation to tackle these new challenges.

To conclude, here is a summary of key strategies for scaling a system to support millions of users:
...
Congratulations on getting this far!Take a moment to appreciate your progress—great job!
...
7. [Scaling Memcache at Facebook (NSDI '13)](https://www.usenix.org/system/files/conference/nsdi13/nsdi13-final170_update.pdf)

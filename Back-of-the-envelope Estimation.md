...
A Google software engineer built a tool to visualize Dr. Dean’s numbers. The tool also takes the time factor into consideration. Figure 2-1 shows the visualized latency numbers as of 2020 (source: reference material [3]).

<div align="center">
  <img src="images/back-of-the-envelope-estimation/figure-1.png"/>
</div>
...
5. [Compute Engine Service Level Agreement (Google Cloud)](https://cloud.google.com/compute/sla)

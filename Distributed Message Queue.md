...
<div align="center">
  <img src="images/distributed-message-queue/image-001.png" width="600"/>
  <p>Figure 1 Popular distributed message queues</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-002.svg" width="600"/>
  <p>Figure 2 Key components in a message queue</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-003.svg" width="600"/>
  <p>Figure 3 Point-to-point model</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-004.svg" width="600"/>
  <p>Figure 4 Publish-subscribe model</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-005.svg" width="600"/>
  <p>Figure 5 Partitions</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-006.svg" width="600"/>
  <p>Figure 6 Message queue cluster</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-007.svg" width="600"/>
  <p>Figure 7 Consumer groups</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-008.svg" width="600"/>
  <p>Figure 8 High-level design</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-009.svg" width="600"/>
  <p>Figure 9 Append new messages</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-010.svg" width="600"/>
  <p>Figure 10 Data segment file distribution in topic partitions</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-011.svg" width="600"/>
  <p>Figure 11 Routing layer</p>
</div>
...
2. The routing layer reads the replica distribution plan[1](https://bytebytego.com/courses/system-design-interview/distributed-message-queue?redirect=%2Fcourses%2Fsystem-design-interview%2Fdistributed-message-queue#user-content-fn-1)from the metadata storage and caches it locally. When a message arrives, it routes the message to the leader replica of partition 1, which is stored in broker 1.
...
<div align="center">
  <img src="images/distributed-message-queue/image-012.svg" width="600"/>
  <p>Figure 12 Producer with buffer and routing</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-013.svg" width="400"/>
  <p>Figure 13 The choice of the batch size</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-014.svg" width="600"/>
  <p>Figure 14 Consumer flow</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-015.svg" width="600"/>
  <p>Figure 15 Pull model</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-016.svg" width="600"/>
  <p>Figure 16 Coordinator of consumer groups</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-017.svg" width="600"/>
  <p>Figure 17 Consumer rebalance</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-018.svg" width="700"/>
  <p>Figure 18 New consumer joins</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-019.svg" width="600"/>
  <p>Figure 19 Existing consumer leaves</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-020.svg" width="600"/>
  <p>Figure 20 Existing consumer crashes</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-021.svg" width="600"/>
  <p>Figure 21 Last consumed offset of consumer groups</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-022.svg" width="700"/>
  <p>Figure 22 Zookeeper</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-023.svg" width="700"/>
  <p>Figure 23 Replication</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-024.svg" width="600"/>
  <p>Figure 24 How ISR works</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-025.svg" width="600"/>
  <p>Figure 25 ack=all</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-026.svg" width="600"/>
  <p>Figure 26 ack=1</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-027.svg" width="600"/>
  <p>Figure 27 ack=0</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-028.svg" width="600"/>
  <p>Figure 28 Broker node crashes</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-029.svg" width="700"/>
  <p>Figure 29 Add new broker node</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-030.svg" width="600"/>
  <p>Figure 30 Partition increase</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-031.svg" width="600"/>
  <p>Figure 31 Partition decrease</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-032.svg" width="700"/>
  <p>Figure 32 At-most once</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-033.svg" width="700"/>
  <p>Figure 33 At-least once</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-034.svg" width="700"/>
  <p>Figure 34 Exactly once</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-035.svg" width="700"/>
  <p>Figure 35 Message filtering by tags</p>
</div>
...
<div align="center">
  <img src="images/distributed-message-queue/image-036.svg" width="500"/>
  <p>Figure 36 Delayed messages</p>
</div>
...
- Protocol: it defines rules, syntax, and APIs on how to exchange information and transfer data between different nodes. In a distributed message queue, the protocol should be able to: Some popular protocols include Advanced Message Queuing Protocol (AMQP) \[18\] and Kafka protocol \[19\].
...
<div align="center">
  <img src="images/distributed-message-queue/image-037.png" width="600"/>
</div>
